...
public class SauvegardeDocument {
    static void sauvergardeFacturation(String clientName, double montantHT, double tva, double total) {
    ...
    static void sauvergardeDevis(double montantHT, double tva, double total) {
